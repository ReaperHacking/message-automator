'''
Modified version without the time.sleep() so just in case you don't wanna wait for each message to load, here you go it will come in an instant!

Check lines 7 and 18 for refrence :)
'''

# Where import time would've been
...
def automation(msg, count):
  for i in range(count):
   ...
   # Here is where the time.sleep() would've been
